...
public class EnergyController {
    ...
    private static final List<UsageData> SAMPLE_DATA = List.of(
            new UsageData(LocalDateTime.of(2025, 1, 10, 10, 0), 10.5, 9.8, 0.5),
            new UsageData(LocalDateTime.of(2025, 1, 10, 11, 0), 12.3, 11.5, 1.2),
            new UsageData(LocalDateTime.of(2025, 1, 10, 12, 0), 15.0, 14.0, 2.0),
            new UsageData(LocalDateTime.of(2025, 1, 10, 13, 0), 15.015, 14.033, 2.049),
            new UsageData(LocalDateTime.of(2025, 1, 10, 14, 0), 18.05, 18.05, 1.076),
            new UsageData(LocalDateTime.of(2025, 1, 10, 15, 0), 14.2, 13.5, 1.8),
            new UsageData(LocalDateTime.of(2025, 1, 10, 16, 0), 11.0, 10.2, 2.5),
            new UsageData(LocalDateTime.of(2025, 1, 10, 17, 0), 8.5, 8.0, 3.1)
    );
